...
DEFINE_string(source, "/home/xmf/xmf_catkin_ws/FASTLIO2_SAM_LC/map/map.pcd", "点云路径");
DEFINE_string(source_filtered, "/home/xmf/xmf_catkin_ws/FASTLIO2_SAM_LC/map/map_filted.pcd", "点云路径");

int main(int argc, char** argv) {
    FLAGS_log_dir = "/home/xmf/xmf_slam/slam_test/log";
